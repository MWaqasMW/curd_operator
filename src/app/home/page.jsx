      ...
      <header className="relative w-full border-b bg-white pb-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="lg:hidden">
            <BsAlexa onClick={toggleMenu} className="h-6 w-6 cursor-pointer" />
          </div>
          {isMenuOpen && (
          ...
          <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16">
            <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200">
              ...
              >
                ...
                <BsAlexa className="h-5 w-5 text-gray-500" />
              </button>
            ...
            {Array.from({ length: 2 }).map((_, i) => (
              ...
              >
                ...
                >
                  ...
                  <BsAlexa className="hidden h-5 w-5 text-gray-500 md:block" />
                </button>
              </div>
            ))}
          </div>
                ...
                <div className="px-9 pb-9 pt-8">
                  ...
                  <ul className="mb-11">
                    <li className="mb-4 flex items-center">
                      <BsAlexa className="mr-2" size={16} />
              ...
              <div className="mt-2 flex items-center">
                <div className="flex space-x-1">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <BsAlexa key={i} className="h-5 w-5 text-yellow-400" />
                  ))}
                </div>
